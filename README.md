...
A modern property management platform built with Nuxt 3, Directus CMS, and shadcn-vue. This application provides comprehensive HOA/property management features including authentication, payment processing, member management, and document handling.
...
- **Financial Management**: Comprehensive HOA financial system with budgeting, reconciliation, compliance monitoring, reserve studies, and audit logging -- see the [Financial System Guide](docs/financial-system.md)
...
For detailed documentation on the financial system composables (`useBudgetManagement`, `useReconciliationNotes`, `useTransactionMatching`, `useFinancialDashboard`, `useReserveStudy`, `useAssessmentLedger`, `useComplianceAlerts`, `useAuditLog`), see the [Financial System Guide](docs/financial-system.md).
