...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "siteUrl": "http://1033lenox.com",
    "directus": {
      "rest": {
        "baseUrl": "https://admin.1033lenox.com",
        "nuxtBaseUrl": "http://1033lenox.com"
      },
      "auth": {
        "enabled": true,
  ...
  "nuxt-og-image": {
    ...
    "assetDirs": [
      "/Users/peterhoffman/Sites/1033/website/public",
      "/Users/peterhoffman/Sites/1033/website/node_modules/nuxt-og-image/dist/runtime/public-assets",
      "/Users/peterhoffman/Sites/1033/website/node_modules/nuxt-og-image/dist/runtime/public-assets-optional/inter-font",
      "/Users/peterhoffman/Sites/1033/website/node_modules/nuxt-og-image/dist/runtime/public-assets-optional/inter-font",
      "/Users/peterhoffman/Sites/1033/website/node_modules/nuxt-og-image/dist/runtime/public-assets-optional/resvg",
      "/Users/peterhoffman/Sites/1033/website/node_modules/nuxt-og-image/dist/runtime/public-assets-optional/yoga",
      "/Users/peterhoffman/Sites/1033/website/node_modules/nuxt-og-image/dist/runtime/public-assets-optional/svg2png"
    ]
  }
};
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/peterhoffman/Sites/1033/website/.data/kv"}));
...
const _UREmL4oOYe = InjectStatePlugin;

const OgImagePrenderNitroPlugin = async (nitroApp) => {
  return;
};
const _Ar5SnEuZD2 = OgImagePrenderNitroPlugin;
...
const _hYH62tKXDq = (function(nitro) {
...
const _Gh2KQL = defineEventHandler((e) => {
...
const _RCB6ls = defineEventHandler(async (e) => {
...
const pages = [
  {
    "loc": "/account",
    "lastmod": "2023-11-16T19:29:03.646Z"
  },
  {
    "loc": "/announcements",
    "lastmod": "2023-11-16T19:16:32.355Z"
  },
  {
    "loc": "/auth/logout",
    "lastmod": "2023-10-27T15:30:45.467Z"
  },
  {
    "loc": "/auth/password-reset",
    "lastmod": "2023-11-08T19:35:12.957Z"
  },
  {
    "loc": "/auth/signin",
    "lastmod": "2023-11-16T19:40:21.623Z"
  },
  {
    "loc": "/auth/user-invite",
    "lastmod": "2023-11-08T20:22:10.466Z"
  },
  {
    "loc": "/documents",
    "lastmod": "2023-11-16T19:10:51.937Z"
  },
  {
    "loc": "/financials",
    "lastmod": "2023-11-16T19:30:05.969Z"
  },
  {
    "loc": "/",
    "lastmod": "2023-11-16T19:44:46.191Z"
  },
  {
    "loc": "/meetings",
    "lastmod": "2023-11-16T19:11:17.800Z"
  },
  {
    "loc": "/projects",
    "lastmod": "2023-11-16T19:13:44.443Z"
  },
  {
    "loc": "/rules-regulations/garbage-room",
    "lastmod": "2023-11-16T20:16:52.306Z"
  },
  {
    "loc": "/rules-regulations",
    "lastmod": "2023-11-16T19:11:39.618Z"
  }
];
...
const _1UUqsv = defineEventHandler(async (e) => {
  const { moduleConfig, buildTimeMeta } = useRuntimeConfig()["nuxt-simple-sitemap"];
...
const _lazy_633CrE = () => import('../handlers/renderer.mjs').then(function (n) { return n.r; });
const _lazy_UfHfau = () => import('../handlers/og.png.mjs');
const _lazy_CsB9ft = () => import('../handlers/html.mjs');
const _lazy_jVkwf9 = () => import('../handlers/options.mjs');
const _lazy_xV619E = () => import('../handlers/svg.mjs');
const _lazy_LwZG6n = () => import('../handlers/vnode.mjs');
const _lazy_xVncBq = () => import('../handlers/font.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_633CrE, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _Gh2KQL, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _lazy_UfHfau, lazy: true, middleware: false, method: undefined },
  { route: '/api/og-image-html', handler: _lazy_CsB9ft, lazy: true, middleware: false, method: undefined },
  { route: '/api/og-image-options', handler: _lazy_jVkwf9, lazy: true, middleware: false, method: undefined },
  { route: '/api/og-image-svg', handler: _lazy_xV619E, lazy: true, middleware: false, method: undefined },
  { route: '/api/og-image-vnode', handler: _lazy_LwZG6n, lazy: true, middleware: false, method: undefined },
  { route: '/api/og-image-font', handler: _lazy_xVncBq, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _RCB6ls, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _1UUqsv, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_633CrE, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, useStorage as A, prefixStorage as B, defu as C, cachedEventHandler as D, withQuery as E, hasProtocol as F, isScriptProtocol as G, klona as H, getContext as I, sanitizeStatusCode as J, createHooks as K, parse as L, getRequestHeader as M, withHttps as N, hasTrailingSlash as O, withTrailingSlash as P, isEqual as Q, setCookie as R, getCookie as S, deleteCookie as T, parseQuery as U, vercel as V, send as a, setResponseStatus as b, setResponseHeaders as c, useRuntimeConfig as d, eventHandler as e, getQuery as f, getResponseStatus as g, createError$1 as h, getRouteRules as i, joinURL as j, hash as k, getResponseStatusText as l, destr as m, defineEventHandler as n, sendRedirect as o, parseURL as p, useNitroOrigin as q, readBody as r, setResponseHeader as s, withoutLeadingSlash as t, useNitroApp as u, setHeader as v, withoutTrailingSlash as w, withBase as x, createDefu as y, withoutBase as z };
