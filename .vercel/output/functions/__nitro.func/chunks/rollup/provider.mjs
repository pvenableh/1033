...
import { b as base64ToArrayBuffer, r as readPublicAsset, a as readPublicAssetBase64, t as toBase64Image, w as wasmLoader } from '../utils.mjs';
import { A as useStorage, x as withBase, d as useRuntimeConfig } from '../nitro/vercel.mjs';
...
const ReSvgLoader = wasmLoader(import("./resvg.wasm?module").then(m => m.default || m), "/resvg.wasm");
