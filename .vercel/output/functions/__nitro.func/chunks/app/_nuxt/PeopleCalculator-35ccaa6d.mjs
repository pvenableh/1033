import { useSSRContext, defineComponent, toRef, computed, ref, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString } from 'vue';
import { twMerge, twJoin } from 'tailwind-merge';
import { k as kbd, t as tooltip, u as useUI, _ as __nuxt_component_3 } from './Avatar-d4c2b86a.mjs';
import { m as mergeConfig, e as appConfig, i as defu } from '../server.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full flex flex-col md:flex-row people-calculator" }, _attrs))}>`);
      if (__props.people.length) {
        _push(`<p class="w-full md:w-1/2 tracking-wide"><span class="opacity-50">Attendance: </span>${ssrInterpolate(__props.people.length)} Including `);
        if (unref(boardMembers).length) {
          _push(`<span>${ssrInterpolate(unref(boardMembers).length)} Board Members</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</p>`);
      ...
      _push(`<div class="w-full mt-2 md:mt-0 md:w-1/2 flex items-end md:justify-end flex-row"><!--[-->`);
      ssrRenderList(unref(boardMembers), (person, index) => {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_UAvatar, {
                size: "xs",
                "chip-color": "primary",
                src: "https://ui-avatars.com/api/?name=" + person.first_name + "-" + person.last_name + "&background=eeeeee&color=66666",
      ...
      _push(`<!--]--><!--[-->`);
      ssrRenderList(unref(nonBoardMembers), (person, index) => {
        _push(ssrRenderComponent(_component_UTooltip, {
          key: index,
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Meetings/PeopleCalculator.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_0 = _sfc_main;

export { __nuxt_component_0 as _ };
//# sourceMappingURL=PeopleCalculator-35ccaa6d.mjs.map
