<template>
	<div
		...
		@click="handleClick">
		<!-- Unread indicator -->
		<div v-if="!isRead" class="absolute left-1.5 top-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-yellow-500" />

		<div class="flex items-start gap-3">
			<!-- Icon -->
			<div
				class="flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center bg-yellow-100 dark:bg-yellow-900/30">
				<Icon name="i-heroicons-megaphone" class="w-4 h-4 text-yellow-600 dark:text-yellow-400" />
			</div>
