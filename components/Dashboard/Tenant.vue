  ...
  <div class="grid grid-flow-row-dense grid-cols-2 gap-x-4 gap-y-12 lg:gap-y-20 lg:gap-x-10 dashboard">
    ...
    <div class="col-span-2 lg:col-span-1 insight">
      ...
      <div v-if="activeLease" class="lease-status">
        ...
        <div v-if="daysUntilLeaseExpires !== null" class="mb-4">
          ...
          <p class="font-bold" :class="daysUntilLeaseExpires <= 30 ? 'text-orange-500' : daysUntilLeaseExpires <= 7 ? 'text-red-500' : ''">
      ...
      <div v-else class="text-center py-8">
        <UIcon name="i-heroicons-document-text" class="text-4xl opacity-25 mb-2" />
    ...
    <div class="col-span-2 lg:col-span-1 insight">
      ...
      <div v-if="userUnits.length" class="space-y-4">
        <div v-for="(unit, index) in userUnits" :key="index" class="unit-card p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
      ...
      <div v-else class="text-center py-8">
        <UIcon name="i-heroicons-home" class="text-4xl opacity-25 mb-2" />
    ...
    <div class="col-span-2 lg:col-span-1 insight">
      ...
      <div v-if="userUnits.length && userUnits.some(u => u.units_id?.vehicles?.length)">
        <div v-for="(unit, index) in userUnits" :key="index">
          <div v-for="(vehicle, vIndex) in unit.units_id?.vehicles || []" :key="vIndex" class="mb-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div class="flex items-center gap-3">
              <UIcon name="i-heroicons-truck" class="text-2xl opacity-50" />
              <div>
      ...
      <div v-else class="text-center py-8">
        <UIcon name="i-heroicons-truck" class="text-4xl opacity-25 mb-2" />
    ...
    <div class="col-span-2 lg:col-span-1 insight">
      ...
      <div v-if="userUnits.length && userUnits.some(u => u.units_id?.pets?.length)">
        <div v-for="(unit, index) in userUnits" :key="index">
          <div v-for="(pet, pIndex) in unit.units_id?.pets || []" :key="pIndex" class="mb-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <div class="flex items-center gap-3">
              <UIcon name="i-heroicons-heart" class="text-2xl opacity-50" />
              <div>
      ...
      <div v-else class="text-center py-8">
        <UIcon name="i-heroicons-heart" class="text-4xl opacity-25 mb-2" />
