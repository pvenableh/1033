...
<template>
	<div class="grid grid-flow-row-dense grid-cols-2 gap-x-4 gap-y-12 lg:gap-y-20 lg:gap-x-10 dashboard">
		...
		<InsightsBoardMember v-if="boardMember" :board-member="boardMember" class="col-span-2 lg:col-span-1" />
		...
		<div class="col-span-2 lg:col-span-1 insight">
			...
			<div class="grid grid-cols-2 gap-4">
				<div
					class="stat-card p-4 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg text-center">
				...
				<div
					class="stat-card p-4 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg text-center">
				...
				<div
					class="stat-card p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg text-center">
				...
				<div
					class="stat-card p-4 bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 rounded-lg text-center">
		...
		<div class="col-span-2 insight">
			...
			<div class="grid grid-cols-2 md:grid-cols-4 gap-4">
				<nuxt-link
					...
					<Icon name="i-heroicons-document-text" class="text-2xl mb-2 opacity-75" />
					<p class="text-sm font-bold uppercase tracking-wide">Documents</p>
				</nuxt-link>
				<nuxt-link
					to="/meetings"
					class="action-card p-4 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-center">
					<Icon name="i-heroicons-calendar" class="text-2xl mb-2 opacity-75" />
					<p class="text-sm font-bold uppercase tracking-wide">Meetings</p>
				</nuxt-link>
				<nuxt-link
					to="/requests"
					class="action-card p-4 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-center">
					<Icon name="i-heroicons-clipboard-document-list" class="text-2xl mb-2 opacity-75" />
					<p class="text-sm font-bold uppercase tracking-wide">Requests</p>
				</nuxt-link>
				<nuxt-link
					to="/projects"
					class="action-card p-4 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-center">
					<Icon name="i-heroicons-rectangle-stack" class="text-2xl mb-2 opacity-75" />
