		...
		<div class="col-span-2 insight">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
					...
					<p class="text-sm opacity-75">Contact the building management for general inquiries and assistance.</p>
				</div>
				<div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
					<h3 class="uppercase tracking-wide text-sm font-bold mb-2">Submit a Request</h3>
					<p class="text-sm opacity-75 mb-3">Have an issue or request? Let us know.</p>
