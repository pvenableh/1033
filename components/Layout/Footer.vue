<template>
	<div class="w-full flex flex-col md:flex-row flex-wrap items-center justify-start sm:justify-center px-4 md:px-6 pb-10 mt-16 md:mt-20 footer">
		...
		<div class="flex w-full flex-col items-center justify-center">
			...
			<h5 class="tracking-widest uppercase body-font copyright">
				&#169; {{ new Date().getFullYear() }} Lenox Plaza Association, LLC
			</h5>
		</div>
	</div>
</template>
