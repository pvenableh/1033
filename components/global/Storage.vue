<template>
	<svg width="84" height="90" viewBox="0 0 84 90" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path
			d="M82.5 0H1.5C0.671625 0 0 0.671625 0 1.5V85.5C0 86.3284 0.671625 87 1.5 87H4.5V90H7.5V87H22.5V90H25.5V87H31.5V90H34.5V87H49.5V90H52.5V87H58.5V90H61.5V87H76.5V90H79.5V87H82.5C83.3284 87 84 86.3284 84 85.5V1.5C84 0.671625 83.3284 0 82.5 0ZM27 84H3V3H27V84ZM54 84H30V3H54V84ZM81 84H57V3H81V84Z"
			fill="#666666" />
