<template>
	<div class="space-y-2">
		<a
			...
			<div class="w-10 h-10 rounded-lg flex items-center justify-center" :class="getFileIconBg(file.directus_files_id)">
				<Icon
			...
			<Icon name="i-heroicons-arrow-down-tray" class="w-4 h-4 text-gray-400 group-hover:text-gold transition-colors" />
		</a>

		<p v-if="files.length === 0" class="text-sm text-gray-400 text-center py-4">No files attached</p>
	</div>
</template>
