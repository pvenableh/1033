<template>
  <div
    class="flex items-start gap-3 p-3 bg-gray-900/5 rounded-lg hover:bg-gray-900/10 transition-colors"
  >
    <!-- Checkbox -->
    <button
      :disabled="isToggling"
    ...
    >
      <UIcon
        v-if="task.completed && !isToggling"
    ...
    <div class="flex-1 min-w-0">
      ...
      <!-- Description -->
      <p
        v-if="task.description && !task.completed"
      ...
      <div class="flex flex-wrap items-center gap-2 mt-1.5">
        ...
        >
          <UAvatar
            :src="getAvatarUrl(task.assignee_id)"
            :alt="task.assignee_id.first_name || 'User'"
            size="3xs"
          />
      ...
      <!-- Completed info -->
      <p
        v-if="task.completed && task.completed_by"
