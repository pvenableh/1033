<script setup>
useSeoMeta({
	title: 'Door Numbers Vote - 1033 Lenox',
});
...
const renderings = ref([
	{
		id: 1,
		title: 'Top Justified',
		image: '57ffe374-f854-4e8a-9b32-121cde84afb0',
	},
	{
		id: 2,
		title: 'Vertically Stacked',
		image: '8536fd24-7622-4524-ae63-c5bd5dac9ca7',
	},
]);
...
const mailtoLink = computed(() => {
	if (selectedItem?.value) {
		const encodedSubject = `1033 Lenox Door Number Design Vote: ${selectedItem.value.title}`;
...
<template>
	<div class="flex items-center justify-center flex-col w-full renderings">
		<div class="w-full mb-8 max-w-[500px] lg:max-w-[1000px] px-2 lg:px-0 renderings__intro">
			<h1 class="text-3xl lg:text-5xl uppercase font-bold text-center mt-10 mb-8 lg:mt-12">Door Number Designs</h1>
			...
			<div class="w-full flex items-center justify-start flex-col mt-6 px-4 max-w-[450px] mx-auto">
				...
				<p class="w-full mt-6 mb-2 text-[14px] leading-5">
					...
					<span class="font-bold">Friday April 4th, 2025 at 11:59PM EST.</span>
				</p>
			</div>
		</div>
