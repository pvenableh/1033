											...
											<div class="space-y-3 mt-4">
												...
												<div class="bg-gray-100 p-3 rounded text-sm border-t">
													...
													<div class="flex justify-between items-center mt-1">
														...
														<span class="font-bold" :class="category.variance <= 0 ? 'text-green-600' : 'text-red-600'">
															{{
																category.variance <= 0
						...
						<UCard>
							...
							<UTable :rows="displayTransactions" :columns="transactionColumnsDetailed">
								...
								<template #is_violation-data="{row}">
									...
									<UBadge v-else-if="isTransferTransaction(row)" color="blue" variant="soft" size="xs">TRANSFER</UBadge>
