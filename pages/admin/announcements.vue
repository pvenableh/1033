  ...
  try {
    const response = await $fetch<Announcement[]>('/api/directus/items', {
      ...
      body: {
        ...
        operation: 'list',
        query: {
          fields: ['*', 'recipients.people_id.first_name', 'recipients.people_id.last_name', 'recipients.people_id.email'],
          sort: ['-date_created'],
          limit: 100,
        },
      },
  ...
  <div class="admin-page bg-white dark:bg-gray-900 min-h-full">
    <div class="container mx-auto px-6 py-8">
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-1">
            Create, edit, and send email announcements to residents
          </p>
        </div>
          ...
          >
            <template #title-data="{ row }">
              <div class="max-w-md">
                <div class="flex items-center gap-2">
                  ...
                  <UBadge v-if="row.urgent" color="red" variant="soft" size="xs">Urgent</UBadge>
                </div>
            ...
            <template #recipients-data="{ row }">
              <span class="text-sm text-gray-600">
                {{ getRecipientCount(row) }} recipients
              </span>
            </template>
        ...
        <UCard>
          ...
          <div class="space-y-4">
            <UFormGroup label="Title" required>
              <UInput v-model="form.title" placeholder="Announcement title" />
            </UFormGroup>

            <UFormGroup label="Subtitle">
              <UInput v-model="form.subtitle" placeholder="Brief summary" />
            </UFormGroup>
      ...
      <UModal v-model="showSendModal" :ui="{ width: 'sm:max-w-3xl' }">
        <UCard v-if="selectedAnnouncement">
          <template #header>
            <div class="flex items-center justify-between">
              <div>
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex gap-2">
                ...
                <UButton size="xs" variant="ghost" @click="clearRecipients">Clear</UButton>
              </div>
            </div>
            ...
            <div class="border rounded-lg max-h-[400px] overflow-y-auto">
              ...
              <div v-else class="divide-y">
                ...
                >
                  ...
                  />
                  <UAvatar :alt="`${person.first_name} ${person.last_name}`" size="sm" />
          ...
          <template #footer>
            <div class="flex justify-end gap-3">
              <UButton color="gray" variant="ghost" @click="showSendModal = false">
                Cancel
              </UButton>
              <UButton
                color="green"
