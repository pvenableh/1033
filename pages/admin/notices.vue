	...
	<div class="admin-page bg-white dark:bg-gray-900 min-h-full">
		<div class="container mx-auto px-6 py-8">
			...
			<div v-if="!hasAccess" class="text-center py-12">
				...
				<p class="text-gray-600 dark:text-gray-400">You don't have permission to manage notices.</p>
			</div>
					...
					<div class="space-y-4">
						...
						<FormGroup label="Content">
							<ClientOnly>
								...
								<template #fallback>
									<div
										class="min-h-[150px] border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
