		...
		<div class="container mx-auto px-4 py-6">
			...
			<div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
				<div>
					...
					<p class="text-gray-600 dark:text-gray-400 mt-1">View ongoing and completed building projects</p>
				</div>
				...
				<Card
					...
					<template #header>
						<div class="flex items-center gap-3">
							<div class="w-4 h-4 rounded-full flex-shrink-0" :style="{backgroundColor: project.color || '#C4A052'}" />
					...
					<div class="space-y-3">
						...
						<div v-if="project.category_id" class="flex items-center gap-2">
							<Icon name="i-heroicons-tag" class="w-4 h-4 text-gray-400" />
							<Badge
								:style="{
									backgroundColor:
										typeof project.category_id === 'object' ? project.category_id.color + '20' : undefined,
			...
			<div v-else class="text-center py-12">
				<Icon name="i-lucide-chart-no-axes-gantt" class="w-16 h-16 text-gray-300 mx-auto mb-4" />
