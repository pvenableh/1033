            ...
            <div class="w-full flex items-center justify-center flex-col email__body" v-if="email">
                ...
                <div class="w-full email__content">
                    ...
                    <div class="w-full flex flex-row flex-wrap items-start signature">
                        ...
                        <p class="tracking-wide font-bold uppercase w-full sm:w-1/2">Camila Hoffman<span
                                class="icon">✨</span><span class="title">Secretary</span></p>
                        <p class="tracking-wide font-bold uppercase w-full sm:w-1/2">Nenad Rakita<span
                                class="icon">🏊‍♂️</span><span class="title">Treasurer</span></p>
                        <p class="tracking-wide font-bold uppercase w-full sm:w-1/2">Cecilia V. Demattos<span
                                class="icon">🪴</span>
                        </p>
                    </div>
                </div>
